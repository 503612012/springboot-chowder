package com.oven.influxdb.config;
...
public class InfluxDbTemplate {
     ...
     * @param unit        单位
     */
    public void write(String database, String measurement, Map<String, String> tags, Map<String, Object> fields, long time, TimeUnit unit) {
     ...
     * @param fields      字段
     */
    public void write(String database, String measurement, Map<String, String> tags, Map<String, Object> fields) {
        write(database, measurement, tags, fields, System.currentTimeMillis(), TimeUnit.MILLISECONDS);
    }
     ...
     * @return 结果
     */
    public <T> List<T> query(String selectCommand, String database, Class<T> clazz) {
        return handleQueryResult(query(selectCommand, database), clazz);
    }
